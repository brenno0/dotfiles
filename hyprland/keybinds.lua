...
hl.bind("SUPER + SHIFT + B", hl.dsp.global("quickshell:sidebarLeftToggle"))
...
hl.bind("ALT + F4",
    function()
        hl.exec_cmd(
            "notify-send \"Wrong close keybind\" \"Super+W to close. Use Alt+F4 for Windows VMs\" -a Hyprland")
    end,
    { non_consuming = true })
...
hl.bind("SUPER + B", hl.dsp.exec_cmd("zen-browser"), { description = "App: Browser" })
